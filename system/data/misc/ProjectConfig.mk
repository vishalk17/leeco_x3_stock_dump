...
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw s5k3l9_mipi_raw s5k5e8yx_mipi_raw s5k5e9yx_mipi_raw
CUSTOM_HAL_LENS = bu6429af lc898217af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = s5k3l9_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_LENS = lc898217af
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8_mipi_raw
CUSTOM_HAL_MAIN_LENS = bu6429af
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = s5k5e9yx_mipi_raw
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = s5k5e8yx_mipi_raw
CUSTOM_HAL_SUB_LENS = 
CUSTOM_KERNEL_ACCELEROMETER = y
CUSTOM_KERNEL_ALSPS = y
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw s5k3l9_mipi_raw s5k5e8yx_mipi_raw s5k5e9yx_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = bu6429af lc898217af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = y
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = s5k3l9_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_LENS = lc898217af
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = bu6429af
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW =
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = s5k5e9yx_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_LENS = 
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k5e8yx_mipi_raw
CUSTOM_KERNEL_SUB_LENS = 
CUSTOM_KERNEL_TOUCHPANEL = synaptics_3320_letv synaptics_3320u_letv atmel_mxt
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator

ifeq ($(TARGET_CARRIER), hongkong)
CUSTOM_MODEM = letv6795_lwt_lv_m_lwg
else ifeq ($(TARGET_CARRIER), india)
CUSTOM_MODEM = letv6795_lwt_lv_m_lwg
else ifeq ($(TARGET_CARRIER), thailand)
CUSTOM_MODEM = letv6795_lwt_lv_m_lwg
else
CUSTOM_MODEM = letv6795_lwt_lv_m_lwg letv6795_lwt_lv_m_lttg
endif
...
MD32_TOOLCHAIN_MODULE = IPDesigner/12R1.35-64
MD5_SIZE = 0x01600000
...
MTK_CAM_DISTANCE_MEASURE_SUPPORT = no
...
MTK_CAM_IMAGE_REFOCUS_SUPPORT = no
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_platform_mt6795
...
#leeco: defined it in server build script
...
MTK_TC1_FEATURE = no
MTK_TC7_COMMON_DEVICE_INTERFACE = yes
...
LETV_DIRAC_SUPPORT = yes
#CREATE_PROJECT_INFO=20160223211318
CUSTOM_LK_USB_UNIQUE_SERIAL = yes
LETV_SPECIAL_LOGO_SHOW = yes
PROJECT_X3_SUPPORT = yes
MTK_FINGERPRINT = GF5118M
# leeco set oem unlock enable default
LEUI_OEM_UNLOCK_ENABLE = yes
